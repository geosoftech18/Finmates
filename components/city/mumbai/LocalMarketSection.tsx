...
const painPoints = [
  {
    ...
    body: `Mumbai's rapid-growth sectors routinely face a dangerous mismatch between receivables and operational burn. Average debtor cycles stretching 45–90 days across manufacturing, logistics, and professional services push founders to fund daily operations on personal credit, eroding the capital meant for growth. Our part-time CFO services in Mumbai install weekly cash flow models and working-capital guardrails so growth never stalls.`,
    stat: '68%',
  ...
  },
  {
    ...
    body: `•	 Operating under Maharashtra's layered regulatory environment is a constant operational hurdle. Professional Tax compliance, STPI/SEZ norms for tech firms, and shifting FEMA obligations for foreign investor-backed businesses demand proactive attention. Missed deadlines create massive administrative liabilities that consume months of leadership focus. Our Virtual CFOs maintain an airtight compliance calendar and coordinate directly with your statutory auditors.  `,
    stat: '3.2×',
  ...
  },
  {
    ...
    body: `•	 Mumbai's commercial spaces are among the most expensive in Asia, and the talent war for mid-to-senior professionals shows no sign of easing. For service businesses, people costs alone can consume 55–70% of revenue, leaving dangerously thin margins that evaporate the moment a key client delays payment. Strategic CFO intervention through strict unit-economics engineering and vendor architecture routinely recovers 8–15% of margin within the first 90 days.  `,
    stat: '↑22%',
