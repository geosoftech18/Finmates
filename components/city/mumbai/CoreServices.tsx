...
const services = [
  {
    ...
    desc: 'Annual budgets, rolling forecasts, and variance planning aligned with your growth revenue goals.  ',
    tag: 'Core',
  },
  {
    icon: BarChart3,
    title: 'Cash Flow Management',
    desc: '13-week rolling forecasts, liquidity optimization, and working capital engineering.  ',
    tag: 'Critical',
  },
  {
    icon: FileText,
    title: 'MIS Reporting',
    desc: 'Custom management information systems for monthly board-level clarity.',
    tag: 'Core',
  },
  {
    icon: Target,
  ...
  },
  {
    ...
    desc: 'Quarter-on-quarter updates, investor relations, cap table management, and compliance data rooms.  ',
    tag: 'Premium',
  },
  {
    icon: LineChart,
    title: 'Financial Modeling',
    desc: 'Multi-scenario dynamic forecasting tools, DCF evaluations, and unit-economic stress tests.',
    tag: 'Premium',
  },
  {
    icon: Scissors,
    title: 'Cost Optimization',
    desc: 'Fixed-cost minimization, vendor negotiations, and overhead margin recovery programs.  ',
    tag: 'Core',
  },
  {
    icon: LayoutDashboard,
    title: 'KPI Dashboards',
    desc: 'Real-time tracking of operational, financial, and departmental health metrics.  ',
    tag: 'Core',
  },
  {
    icon: Receipt,
    title: 'Tax Planning & Compliance',
    desc: 'Strategic positioning for Direct Tax, GST architecture, and state level incentives.  ',
    tag: 'Compliance',
  },
  {
    icon: Shield,
    title: 'Risk Management',
    desc: 'Internal controls framework, corporate hedging strategies, and risk mitigation protocols.  ',
    tag: 'Premium',
  },
  {
    icon: Rocket,
    title: 'Fundraising Support',
    desc: 'Pitch deck architecture, full valuation documentation, due-diligence management, and term-sheet review.  ',
    tag: 'Premium',
  },
  {
    icon: Calculator,
    title: 'Business Forecasting',
    desc: 'Predictive market scenario models and long-term 3-to-5 year scaling frameworks.  ',
    tag: 'Core',
  },
] as const;
